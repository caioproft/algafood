...
public class CozinhaService {
    ...
    private static String COZINHA_EM_USO = "A cozinha de código %d não pode ser excluída, pois está em uso por algum restaurante";
    ...
    public Cozinha atualizar(Long id, Cozinha cozinha) {
        Cozinha cozinhaExistente = repository.findById(id).orElseThrow(() -> new EntidadeNaoCadastradaException(String.format(COZINHA_NÂO_ENCONTRADA, id)));
    ...
    public void excluir(Long id) {
        ...
        try {
            Cozinha cozinha = repository.findById(id).orElseThrow(() -> new EntidadeNaoCadastradaException(String.format(COZINHA_NÂO_ENCONTRADA, id)));
