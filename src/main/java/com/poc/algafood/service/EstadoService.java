...
public class EstadoService {
    ...
    public Estado buscaEstadoOuLancaExcecao(String nome) {
        return estadoRepository.findByNome(nome).orElseThrow(() -> new EntidadeNaoCadastradaException(String.format("Não existe um estado cadastrado com o nome: %s", nome)));
    }
}
