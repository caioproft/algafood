...
public class EstadoController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> atualizarEstadoCompleto(@PathVariable Long id, @RequestBody Estado estado) {
        try {
    ...
    @PatchMapping("/{id")
    public ResponseEntity<?> atualiarEstadoParcialmente(@PathVariable Long id, @RequestBody Map<String, Object> estadoComAtualizacao) {
        try {
